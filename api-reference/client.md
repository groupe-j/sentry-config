...
`replaysOnErrorSampleRate`. See [ReplayMode](#replaymode).
...
blocker can refuse independently. See [InitSentryClientBaseOptions.replayCdnBaseUrl](#replaycdnbaseurl).
...
> **ReplayMode** = `boolean` \| `"lazy"`

Defined in: [client-core.ts:52](https://github.com/groupe-j/sentry-config/blob/main/src/client-core.ts#L52)
...
[`InitSentryClientOptions`](#initsentryclientoptions)
